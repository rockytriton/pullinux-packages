...
install -v -d -m755 $P/usr/share/fonts                               &&
ln -svfn $P$XORG_PREFIX/share/fonts/X11/OTF /usr/share/fonts/X11-OTF &&
ln -svfn $P$XORG_PREFIX/share/fonts/X11/TTF /usr/share/fonts/X11-TTF
